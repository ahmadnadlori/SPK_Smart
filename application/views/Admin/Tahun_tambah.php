  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tambah Tahun Akademik</a></li>
...
<div class="box">
    ...
    <br />
    <br />
   <?php echo form_open('Admin/proses_simpan_tahun')?>
                          <fieldset>
                              <div class="form-group">
                                  <input class="form-control" name="tahun" type="text" placeholder="Tahun Akademik" required>
                              </div>
