...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
     <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Tambah Sub Kriteria</a></li>
    ...
    <br />
    <br />
   <?php echo form_open('Admin/proses_simpan_sub_kriteria')?>
  
                          <fieldset>
                              <div class="form-group">
                                  <input class="form-control" name="nama_sub_kriteria" type="text" placeholder="sub kriteria" required>
                              </div>
                              <div class="form-group">
                                  <input class="form-control" type="number" name="nilai_sub_kriteria" placeholder="nilai sub" required>
                              </div>
                              <div class="form-group">
