...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2023 at 02:39 PM
...
--
-- Table structure for table `smart_akun`
--
...
--
-- Dumping data for table `smart_akun`
--
...
--
-- Table structure for table `smart_kelas`
--
...
--
-- Dumping data for table `smart_kelas`
--
...
--
-- Table structure for table `smart_tahun_akademik`
--
...
--
-- Dumping data for table `smart_tahun_akademik`
--
...
--
-- Constraints for table `smart_alternatif_kriteria`
--
ALTER TABLE `smart_alternatif_kriteria`
...
--
-- Constraints for table `smart_sub_kriteria`
--
ALTER TABLE `smart_sub_kriteria`
